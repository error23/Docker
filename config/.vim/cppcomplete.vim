...
imap <F7> <ESC>:PreviewClass<CR>a
if has("gui_running") 
	if (s:useWinMenu)
		imap <C-J> <ESC>:popup PopUp<CR>a
		imap <C-L> <ESC>:BuildMenu<CR>a
	else
		imap <C-L> <ESC>:BuildMenu<CR><RightMouse>a
		imap <C-J> <ESC><RightMouse>a
	endif
endif
imap <F8> <ESC>:InsNextHit<CR>a
imap <F9> <ESC>:InsPrevHit<CR>a
map <C-F9> <ESC>:PrevInBlock<CR>
map <C-F8> <ESC>:NextInBlock<CR>
